      ...
      <div className="w-full max-w-md bg-white shadow-xl rounded-xl p-7 space-y-6">
        <div className="text-center">
          ...
          <input
            ...
            className="block mx-auto w-full border border-gray-300 rounded-md text-gray-700 p-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          />
        </div>
        <div>
          <label className="text-[#212529] font-[Open Sans] text-sm font-semibold leading-[21.7px] block text-left">
          ...
          <input
            ...
            className="mt-2 block w-full border border-#339AF0 rounded-4 shadow-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2"
          />
        </div>
        <div>
          <label className="text-[#212529] font-[Open Sans] text-sm font-semibold leading-[21.7px] block text-left">
          ...
          <select
            className="mt-2 block w-full border border-gray-300 rounded-md shadow-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2"
            defaultValue=""
          >
            <option
